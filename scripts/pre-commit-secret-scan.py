...
PLACEHOLDER_PATTERNS = re.compile(
    r'YOUR_WEBHOOK_URL|<DISCORD_WEBHOOK_URL>|\[REDACTED\]|\*\*\*|<your-|<strong-|<new_|<pbs-user|<admin-|<db-|<target-|<your_password|CHANGE_ME|__PLACEHOLDER__',
    re.IGNORECASE
)
...
def main():
    ...
    if findings:
        ...
        print("  → Use '[REDACTED]', '***', or '<VAR_NAME>' notation.")
